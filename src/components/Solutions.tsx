      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-24">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              Impetus automates the tedious parts of teaching so you can focus on what matters most: your students. From grading to course creation, everything is streamlined.
            </p>
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              No more clunky interfaces or confusing navigation. Impetus provides a clean, intuitive dashboard where you can find everything you need instantly.
            </p>
